...
@Component({
  selector: 'app-estimates-edit',
  templateUrl: './estimates-edit.component.html',
  styleUrls: ['./estimates-edit.component.scss'],
  providers: [
...
export class EstimatesEditComponent implements OnInit {
  start_date: string;
...
deliveryType = ['DD', 'PP'];
  ...
  AssigntoAll(data)
  {
    ...
    this.invoiceForm.get("pf_number").setValue(data['estimate_no'])
