...
export class BookingEditComponent implements OnInit {
  ...
  displayedColumns: string[] = ['position','s_no', 'p_name', 'rate','qty','amount','action'];
...
deliveryType = ['DD', 'PP'];
  ...
  AssigntoAll(data)
  {
    ...
    this.estimatedate.setValue(new Date(this.apiservice.changedate(data['booking_date'])))
    ...
    this.estimate_date = data['booking_date']
  ...
  create_estimate()
  {
    ...
    this.apiservice.openSpinner()
    this.form_status = true
      this.httpClient.post(this.apiservice.EstimateCreateURL, parameters)
        .subscribe(res => {
          // console.log(res);
          this.form_status = false
            if(res['status'])
  ...
  // {
  //     this.form_status = true
  //     var getEstimateDetailsURL = this.apiservice.getEstimateDetailsURL+"?order_id="+this.order_idd
  //     this.httpClient.get(getEstimateDetailsURL).subscribe(data => {
  //       console.log(data)
  //       if(data['details'] != null)
  //       {
  ...
  //         this.actualdata = data['details'];
  //         this.data = this.actualdata;
  //         this.geninvoice.genPDF(this.data,title)
  //     }
  //     else{
  //       this.form_status = false;
  //       this.toastr.error("No Data Found");
